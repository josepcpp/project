    ...
    <div class="flex-1 flex flex-col gap-6 overflow-hidden">
        ...
        <div class="flex-1 flex flex-col overflow-hidden bg-white rounded-[2rem] border border-slate-100 shadow-sm">
            ...
            <div class="flex-1 overflow-y-auto no-scrollbar">
                <div id="product-grid" class="flex flex-col divide-y divide-slate-50">
                    ...
                    <div class="item-box flex items-center gap-3 px-5 py-3 border-l-[3px] <?= $accent_bar ?> <?= $row_bg ?> transition-colors">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-2 flex-wrap">
                                <span class="product-name font-bold text-slate-800 text-sm leading-tight"><?= htmlspecialchars($p['name']) ?></span>
                                <span class="text-[8px] font-black text-slate-400 bg-slate-100 px-2 py-0.5 rounded uppercase tracking-wide shrink-0"><?= htmlspecialchars($p['category']) ?></span>
                                <?php if ($tiers_warn): ?>
                        ...
                        <div class="w-20 flex justify-center shrink-0">
                            <span class="text-[9px] font-black text-emerald-600 bg-emerald-50 border border-emerald-100 px-2.5 py-1 rounded-lg"><?= $effective_qty ?> left</span>
                        </div>

                        <!-- Price -->
                        <div class="w-24 text-right shrink-0">
                            <span class="text-base font-black text-slate-900 tracking-tight">₱<?= number_format($p['price'], 2) ?></span>
                        </div>
